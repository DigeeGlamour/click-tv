...
class FinalDesignContractTests(unittest.TestCase):
  ...
  ['favorites', 'Favorites']
    ...
    def test_reference_design_is_external_and_preserves_the_three_column_contract(self) -> None:
        self.assertIn("reference-design.css?v=20260812-reference-v15", self.index)
        self.assertIn("app.js?v=20260812-reference-v8", self.index)
        ...
        self.assertIn('width:min(80vw,400px)!important', self.reference_css)
        self.assertIn('grid-auto-rows:76px!important', self.reference_css)
        self.assertIn('grid-auto-rows:182px!important', self.reference_css)
