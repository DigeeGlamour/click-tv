...
class FinalDesignContractTests(unittest.TestCase):
  ...
  ['favorites', 'Favorites']
    ...
    def test_reference_design_is_external_and_preserves_the_three_column_contract(self) -> None:
        self.assertIn("reference-design.css?v=20260811-reference-v8", self.index)
        self.assertIn("app.js?v=20260811-reference-v4", self.index)
        ...
        self.assertIn('grid-template-columns:235px minmax(0,1fr) clamp(390px,24vw,460px)!important', self.reference_css)
        ...
        self.assertIn('--ref-header-h:64px', self.reference_css)
