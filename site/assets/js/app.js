...
const SERIES_ASSET_VERSION = '20260806-manual-series-live-fix6';
...
function ensureSeriesModule() {
  ...
  state.seriesModulePromise = new Promise((resolve) => {
    if (!document.querySelector('link[data-clicktv-series-style]')) {
      const link = document.createElement('link');
      link.rel = 'stylesheet';
      link.href = `assets/css/series.css?v=${SERIES_ASSET_VERSION}`;
      link.dataset.clicktvSeriesStyle = '1';
