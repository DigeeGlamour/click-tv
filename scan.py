...
def run_pipeline(mode: str = "all") -> Dict[str, Any]:
    ...
    print(
        ...
        f"{normalized.get('planned_candidate_count', 0)} planned for verification"
    )
    ...
    print("\n[Step 2/5] Running global stream verification...")
    verify_all_candidates()

    print("\n[Step 3/5] Applying BDIX protection safeguard...")
    bd_summary = verify_bd_candidates()
    ...
    if mode_clean in {"all", "tv", "channels"}:
